...
export const VI_DOMAIN_RULE = [
  ...
  // 越南文「頭銜+人名」語序與中文相反，模型會照抄成「總經理陳嘉元」；順便擋住把 giám đốc 升級成總經理。
  '職稱語序：越南文為「職稱 人名」，中文須改為「人名 職稱」（例：giám đốc @VPIC1 Japlin 陳嘉元 → 陳嘉元 經理）。職稱依術語表對應，不可自行升級或加字（giám đốc 是「經理」，不是「總經理」）。',
  '',
].join('\n');
