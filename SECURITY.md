...
FloorLingo is a self-hosted WhatsApp API gateway. It handles API-key authentication,
...
Report it privately through GitHub Security Advisories — open a private report at
<https://github.com/JaplinChen/FloorLingo/security/advisories/new>
...
FloorLingo already ships several hardening measures: API-key auth with roles
...
When exposing FloorLingo, please review the security-relevant configuration documented in
