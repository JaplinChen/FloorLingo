<p align="center">
  <img src="logo/openwa_logo.webp" alt="FloorLingo Logo" width="200"/>
</p>

<h1 align="center">FloorLingo Documentation</h1>
<p align="center">
...
<p align="center">
  <img src="https://img.shields.io/github/package-json/v/JaplinChen/FloorLingo?label=version&color=blue" alt="Version"/>
...
FloorLingo seeds a default API key on first run and writes it to:
...
curl -X POST http://localhost:2785/api/sessions/{sessionId}/messages/send-text \
  -H "X-API-Key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{"chatId": "628123456789@c.us", "text": "Hello from FloorLingo!"}'
```
...
_FloorLingo Documentation · Last updated: 2026-06-18_
