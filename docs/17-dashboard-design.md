...
The dashboard is a web-based management interface for FloorLingo that lets users manage sessions, webhooks, and monitor activity without using the API directly.
