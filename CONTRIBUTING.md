# Contributing to FloorLingo

Thanks for your interest in improving FloorLingo! This guide covers how to get set up, the
...
FloorLingo is a NestJS (backend) + React/Vite (dashboard) project:
